...
CREATE TABLE "_EditorRelation" (
    ...
    CONSTRAINT "_EditorRelation_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- AddForeignKey
ALTER TABLE "_EditorRelation" ADD CONSTRAINT "_EditorRelation_A_fkey" FOREIGN KEY ("A") REFERENCES "Course"("code") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_AdminRelation" ADD CONSTRAINT "_AdminRelation_A_fkey" FOREIGN KEY ("A") REFERENCES "Course"("code") ON DELETE CASCADE ON UPDATE CASCADE;
