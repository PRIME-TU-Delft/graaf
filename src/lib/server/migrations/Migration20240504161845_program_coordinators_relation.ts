...
export class Migration20240504161845_program_coordinators_relation extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "program_coordinators" ("program_id" varchar(255) not null, "user_id" varchar(255) not null, constraint "program_coordinators_pkey" primary key ("program_id", "user_id"));');
