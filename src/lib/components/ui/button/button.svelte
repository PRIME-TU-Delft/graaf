	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				'outline-muted': 'border border-slate-300 bg-slate-50 text-slate-800 hover:bg-slate-50',
				purple:
					'border border-purple-800 bg-purple-200 text-purple-800 shadow-xs hover:bg-purple-100 hover:underline',
				'purple-outline': 'border border-purple-700 bg-slate-50 text-purple-800 hover:underline',
...
{#if href}
	<!-- eslint-disable svelte/no-navigation-without-resolve -- generic passthrough; callers must resolve() their own href -->
	<a
		bind:this={ref}
		data-slot="button"
