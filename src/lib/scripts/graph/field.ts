...
export function updateField(element: SVGGElement, animated: boolean = false) {
	// Update a field to reperesent its current state. When animated is true, the transition is animated.
...
export function createField(element: SVGGElement) {
	// Create a field element and attach it to the given group element.
