...
import { DomainController, SubjectController, RelationController } from '$scripts/controllers';
...
type RelationSelection = d3.Selection<
	SVGLineElement,
	RelationController<DomainController | SubjectController>,
	d3.BaseType,
	unknown
>;
