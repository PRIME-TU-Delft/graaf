...
<Modal bind:this={archive_modal}>
	...
	Are you certain you want to archive this program?
	When you archive a program, it, and all associated courses and graphs, will no longer be visible to anyone except super-admins. Only they can restore them.
