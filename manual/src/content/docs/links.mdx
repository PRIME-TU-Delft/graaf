...
In the course settings' (1) graph table click the "Link" (2) button next to a graph, and give it a short name (up to 12 characters, letters, numbers and `-`
only).
...
<Aside type="note">
	Deleting a link (1) requires course **admin** permissions. A course editor can create links but
	not delete them, matching the same admin/editor split used elsewhere in a course.
</Aside>
