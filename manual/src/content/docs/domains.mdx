...
You can drag rows (1) to reorder domains. You can also click a domain's color patch (2) directly in the
...
<Aside type="note">
	If someone else edits the graph at the same time as you, you may see a "graph has changed" error
	when deleting. Reload the page and try again.
</Aside>
