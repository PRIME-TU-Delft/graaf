...
<a href={APP_HOST + '/graph-editor/courses'}>Courses page</a>, grouped into "My Pinned Courses",
"All Courses" and "Archived Courses". Use the search bar to find a course by code or name. Click the
pin icon on a course to add or remove it from your pinned list.
...
See the [Roles](../roles) page for the full permission hierarchy and what each role can do.
...
1. Click "Add Super Users"
2. Search for a user by name.
3. Check "User is allowed admin permissions" to add them as an admin, or leave it unchecked to add them as an editor.
4. Click "Add super user" to add the user.

![Add super user](../../assets/courses/add-super-user-1.png)
_Figure 3a: Add super user_
![Add super user](../../assets/courses/add-super-user-2.png)
_Figure 3b: Add super user_
...
_Figure 5: Archive course_

![Restore course](../../assets/courses/restore-course.png)
_Figure 6: Restore course_
...
<Aside type="danger">
	Deleting a course is **irreversible**! If you are unsure, archive the course instead.
</Aside>

0. Archive the course first.
1. Click "Delete Course" in the danger zone.
2. Type the course name to confirm.

![Delete course](../../assets/courses/delete-course-1.png)
_Figure 7a: Delete course_

![Delete course](../../assets/courses/delete-course-2.png)
_Figure 7b: Delete course_
